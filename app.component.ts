...
class AdidasRun extends Make {
  ...
  OutMoney() {
    return this.OutsideMoney = this.money * this.Discount - 150;
...
class AdidasFoot extends Make {
  ...
  OutMoney() {
    return this.OutsideMoney = this.money * this.Discount - 70;
  }
}
class PIKEFoot extends Make {
  ...
  OutMoney() {
    return this.OutsideMoney = (this.money - 20) * this.Discount;
  }
...
class AdidasBask extends Make {
  ...
  OutMoney() {
    return this.OutsideMoney = this.money * this.Discount - 80;
  }
...
class PIKEBask extends Make {
  ...
  OutMoney() {
    return this.OutsideMoney = (this.money - 40) * this.Discount;
  }
...
class NikeRest extends Make {
  ...
  OutMoney() {
    return this.OutsideMoney = this.money * this.Discount - 20;
  }
